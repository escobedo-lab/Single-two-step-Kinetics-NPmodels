...
!      call getallneighborClus()
      ...
      open(unit = 21, File = "id_screen.dat")
      open(unit=22,file='id_screen_num.dat')
!do i=1,NA
! 	write(20,*)  qmavg(i)
! enddo
! close(20)
...
!-------------------------------------------------------------------------                
      ...
      integer i,j,m
      include 'BOcoords.h'
!      open(unit=120, file='q6hist.dat')
!      open(unit=121, file='Ncon.dat')
      do  i = 1,NA_actual
        Nconstar(i) = 0
      enddo  
