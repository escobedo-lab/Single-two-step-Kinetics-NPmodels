      ...
      integer qmavgFLAG
      PARAMETER(NA=13824)
      PARAMETER(rcutnb=1.250d0)
      PARAMETER(rcutcl=1.25d0)
      PARAMETER(rcut=1.900000000001d0)
      PARAMETER(epsstar=7)
      PARAMETER(epsMAX=-1)
      PARAMETER(dcstar=0.53d0)
      PARAMETER(NbMAX=10000)
      PARAMETER(NM=50000000)
      PARAMETER(NMZ=130000000)
      PARAMETER(rcutsqnb=rcutnb**2.0d0)
      PARAMETER(rcutsq=rcut**2.0d0)
      PARAMETER(rcutsqcl=rcutcl**2.0d0)
      PARAMETER(Mq=6)
      PARAMETER(qmavgFLAG=2)
