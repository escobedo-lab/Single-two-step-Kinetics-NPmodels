...
!      call getallneighborClus()
      ...
      open(unit = 21, File = "id_screen_q2B.dat")
      open(unit=22,file='id_screen_num_q2B.dat')
!do i=1,NA
! 	write(20,*)  qmavg(i)
! enddo
! close(20)
